...
<body> 
  ...
  <h1>GOVERNMENT OF GUJRAT</h1>
    ...
    <form action="./workscheduleprocess.php" method="post" enctype="multipart/form-data">
		<h3 style="text-align:center">Upload complete work schedule</h3><hr><br>
        <div class="container"> 
            <center><label><b>Choose File : </b></label> 
            <input type="File" name='workschedule' id='workschedule' accept="application/pdf"required><br><br></center>
